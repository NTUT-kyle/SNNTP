...
class Model_trainer:
    ...
    def load_data(self):
        if not FileFolder.Check_File_Exist(f"./projects/{self.projectName}/Training/", "training_data.csv"):
        ...
        if not FileFolder.Check_File_Exist(f"./projects/{self.projectName}/Test/", "test_data.csv"):
